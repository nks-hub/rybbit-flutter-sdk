...
void main() {
  group('DeviceData userAgent', () {
    test('RFC 7231 format - Samsung Galaxy S23', () {
      ...
      expect(
        data.userAgent,
        'MyApp/1.2.3 (com.example.myapp; Android 14; Samsung SM-S911B) RybbitFlutter/0.2.3',
      );
    });
    ...
    test('RFC 7231 format - Google Pixel 8 Pro', () {
      ...
      expect(
        data.userAgent,
        'Shopping/3.1.0 (com.store.shopping; Android 15; Google Pixel 8 Pro) RybbitFlutter/0.2.3',
      );
    });
    ...
    test('RFC 7231 format - iPhone 15 Pro Max', () {
      ...
      expect(
        data.userAgent,
        'HealthKit/2.0.1 (com.health.tracker; iOS 18.1; iPhone16,2) RybbitFlutter/0.2.3',
      );
    });
    ...
    test('RFC 7231 format - iPad Pro', () {
      ...
      expect(
        data.userAgent,
        'Notes/1.0.0 (com.notes.app; iOS 17.5; iPad14,6) RybbitFlutter/0.2.3',
      );
    });
    ...
    test('RFC 7231 format - app name with dots', () {
      ...
      expect(
        data.userAgent,
        'Chatujme.cz/0.6.20 (com.lury.chatujmeapp; Android 14; Google sdk_gphone64_x86_64) RybbitFlutter/0.2.3',
      );
    });
